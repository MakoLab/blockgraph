...
namespace NBitcoin
{
	...
	public class Transaction : IBlockContent
	{
		...
		static private RawFormatter<Transaction> GetFormatter(RawFormat rawFormat, Network network)
		{
			RawFormatter<Transaction> formatter = null;
			switch (rawFormat)
			{
		...
		internal string ToString(RawFormatter<Transaction> formatter)
		{
			if (formatter == null)
