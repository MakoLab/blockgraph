 ...
 */
	...
	public class TxInUndo : IBitcoinSerializable
	{
		...
		private TxOut txout;         // the txout data before being spent
		...
		private bool fCoinBase;       // if the outpoint was the last unspent: whether it belonged to a coinbase
		...
		private uint nHeight; // if the outpoint was the last unspent: its height
		...
		private uint nVersion;        // if the outpoint was the last unspent: its version
	...
	public class TxUndo : IBitcoinSerializable
	{
		...
		private List<TxInUndo> vprevout = new List<TxInUndo>();
	...
	{
		private List<TxUndo> vtxundo = new List<TxUndo>();
