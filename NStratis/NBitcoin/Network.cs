...
namespace NBitcoin
{
	...
	public partial class Consensus
	{
		...
		{
			private Consensus _Parent;
			private BIP9DeploymentsParameters[] _Parameters;
	...
	public partial class Network
	{
...
#if !NOSOCKET
		private List<DNSSeedData> vSeeds = new List<DNSSeedData>();
		private List<NetworkAddress> vFixedSeeds = new List<NetworkAddress>();
#else
		...
		private static Dictionary<string, Network> _OtherAliases = new Dictionary<string, Network>();
		private static List<Network> _OtherNetworks = new List<Network>();
