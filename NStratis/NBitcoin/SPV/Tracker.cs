...
namespace NBitcoin.SPV
{
	...
	public class Tracker
	{
		...
		private uint _Tweak;
		private ConcurrentDictionary<string, Operation> _Operations = new ConcurrentDictionary<string, Operation>();
		private ConcurrentDictionary<string, TrackedScript> _TrackedScripts = new ConcurrentDictionary<string, TrackedScript>();
		private ConcurrentDictionary<string, TrackedOutpoint> _TrackedOutpoints = new ConcurrentDictionary<string, TrackedOutpoint>();
