...
{
	internal class BlockExplorerFormatter : RawFormatter<Transaction>
	{
		public override Transaction Parse(JObject obj)
		{
		...
		protected override void BuildContent(JObject json, Transaction tx)
		{
