...
namespace NBitcoin.Protocol
{
	...
	{
		private class Bridge : MessageListener<IncomingMessage>
		{
			private MessageProducer<IncomingMessage> _Prod;
			...
			#endregion MessageListener<IncomingMessage> Members
		}
		...
		private MessageProducer<IncomingMessage> _MessageProducer = new MessageProducer<IncomingMessage>();
		...
		private ConcurrentDictionary<Node, Node> _Nodes = new ConcurrentDictionary<Node, Node>();
		...
		#endregion IEnumerable<Node> Members
