...
namespace NBitcoin.Protocol
{
	...
	{
		private TraceCorrelation _Trace = new TraceCorrelation(NodeServerTrace.Trace, "Group connection");
		...
		private AddressManager _DefaultAddressManager = new AddressManager();
