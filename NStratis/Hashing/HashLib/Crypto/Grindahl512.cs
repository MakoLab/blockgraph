namespace HashLib.Crypto
{
	internal class Grindahl512 : BlockHash, ICryptoNotBuildIn
	{
		...
		private static readonly ulong[] s_table_0;
		private static readonly ulong[] s_table_1;
		private static readonly ulong[] s_table_2;
		private static readonly ulong[] s_table_3;
		private static readonly ulong[] s_table_4;
		private static readonly ulong[] s_table_5;
		private static readonly ulong[] s_table_6;
		private static readonly ulong[] s_table_7;

		private static readonly ulong[] s_master_table =
		{
