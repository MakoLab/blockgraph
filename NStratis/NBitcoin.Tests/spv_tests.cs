...
namespace NBitcoin.Tests
{
	...
	{
		private BlockchainBuilder _Builder;
		...
		private ConcurrentDictionary<uint256, Transaction> _Transactions = new ConcurrentDictionary<uint256, Transaction>();
		private ConcurrentDictionary<uint256, uint256> _Known = new ConcurrentDictionary<uint256, uint256>();

		private void _Builder_NewTransaction(Transaction obj)
		{
		...
		private void _Builder_NewBlock(Block obj)
		{
		...
		private Transaction FindTransaction(uint256 id)
		{
